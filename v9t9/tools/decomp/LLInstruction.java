 ...
 * @author ejs
 */
public class LLInstruction extends Instruction {
    /* instruction flags */
	/** changes PC */
    ...
    private LLInstruction next;
    /** Previous instruction, whose next points to this */
    private LLInstruction prev;
	...
	public LLInstruction setNext(LLInstruction next) {
		this.next = next;
		if (next != null)
			next.prev = this;
		return next;
	...
	public LLInstruction getNext() {
		return next;
	}
	
	public LLInstruction getPrev() {
		return prev;
	}
