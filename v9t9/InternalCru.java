...
public class InternalCru implements CruHandler {
    ...
    public InternalCru(Machine machine) {
        ...
        readers = new java.util.TreeMap();
        writers = new java.util.TreeMap();
    }

    private java.util.Map readers, writers;
    ...
    public void writeBits(int addr, int val, int num) {
        ...
        System.out.println("CRU write: >" + Globals.toHex4(addr) + "[" + num + "], " + Globals.toHex4(val));
        ...
        Iterator iter = writers.keySet().iterator();
        while (iter.hasNext() && num > 0) {
            Integer base = (Integer) iter.next();
    ...
    public int readBits(int addr, int num) {
        ...
        System.out.print("CRU read: >" + Globals.toHex4(addr) + "[" + num + "] = ");
        ...
        System.out.println(Globals.toHex4(val));
