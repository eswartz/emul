...
import static v9t9.engine.cpu.InstF99b.CTX_INT;
import static v9t9.engine.cpu.InstF99b.CTX_LP;
import static v9t9.engine.cpu.InstF99b.CTX_PC;
import static v9t9.engine.cpu.InstF99b.CTX_RP;
import static v9t9.engine.cpu.InstF99b.CTX_RP0;
import static v9t9.engine.cpu.InstF99b.CTX_SP;
import static v9t9.engine.cpu.InstF99b.CTX_SP0;
import static v9t9.engine.cpu.InstF99b.CTX_SR;
import static v9t9.engine.cpu.InstF99b.CTX_UP;
...
import static v9t9.engine.cpu.InstF99b.Iccompare;
...
import static v9t9.engine.cpu.InstF99b.Idmath_start;
...
import static v9t9.engine.cpu.InstF99b.IfromLocals;
...
import static v9t9.engine.cpu.InstF99b.Imath_start;
import static v9t9.engine.cpu.InstF99b.Inand;
...
import static v9t9.engine.cpu.InstF99b.ItoLocals;
import static v9t9.engine.cpu.InstF99b.ItoR;
import static v9t9.engine.cpu.InstF99b.Iudivmod;
import static v9t9.engine.cpu.InstF99b.IuloopUp;
...
import static v9t9.engine.cpu.InstF99b.OP_1MINUS;
import static v9t9.engine.cpu.InstF99b.OP_1PLUS;
import static v9t9.engine.cpu.InstF99b.OP_2DIV;
import static v9t9.engine.cpu.InstF99b.OP_2MINUS;
import static v9t9.engine.cpu.InstF99b.OP_2PLUS;
import static v9t9.engine.cpu.InstF99b.OP_2TIMES;
import static v9t9.engine.cpu.InstF99b.OP_ADD;
import static v9t9.engine.cpu.InstF99b.OP_ASH;
import static v9t9.engine.cpu.InstF99b.OP_CSH;
import static v9t9.engine.cpu.InstF99b.OP_INV;
import static v9t9.engine.cpu.InstF99b.OP_LSH;
import static v9t9.engine.cpu.InstF99b.OP_NEG;
import static v9t9.engine.cpu.InstF99b.OP_RSH;
import static v9t9.engine.cpu.InstF99b.OP_SUB;
import static v9t9.engine.cpu.InstF99b.SYSCALL_DEBUG_OFF;
import static v9t9.engine.cpu.InstF99b.SYSCALL_DEBUG_ON;
import static v9t9.engine.cpu.InstF99b.SYSCALL_DECORATED_NUMBER;
import static v9t9.engine.cpu.InstF99b.SYSCALL_FIND;
import static v9t9.engine.cpu.InstF99b.SYSCALL_GFIND;
import static v9t9.engine.cpu.InstF99b.SYSCALL_IDLE;
import static v9t9.engine.cpu.InstF99b.SYSCALL_NUMBER;
import static v9t9.engine.cpu.InstF99b.SYSCALL_REGISTER_SYMBOL;
import static v9t9.engine.cpu.InstF99b.SYSCALL_SPIN;
        	...
        	switch (mop1.immed) {
	        	case SYSCALL_DEBUG_OFF: {
	            	...
	            	if ((oldCount == 0) != (executor.debugCount == 0))
	            		Cpu.settingDumpFullInstructions.setBoolean(false);
	            	break;
	        	}
