/*
  TI994StandardConsoleMemoryModel.java
...
/**
 * The standard TI-99/4 console memory map.
 * @author ejs
 */
public class TI994StandardConsoleMemoryModel extends BaseTI994AMemoryModel {
    static public final SettingSchema settingRomFileName = new SettingSchema(
    		ISettingsHandler.MACHINE,
    		"RomFileName", "994_rom.bin");
    static public final SettingSchema settingGromFileName = new SettingSchema(
    		ISettingsHandler.MACHINE,
    		"GromFileName", "994_grom.bin");
	...
	static protected final MemoryEntryInfo cpuRomInfo = MemoryEntryInfoBuilder
		...
		.withFileMD5("9934C9F8D3E597945A2016186ED038BA")
		.withDescription("TI-99/4 Console ROM")
		.create("CPU ROM");
	...
	static protected final MemoryEntryInfo cpuGromInfo = MemoryEntryInfoBuilder
		...
		.withFileMD5("7B231DB4AFA1F25F8112CB696806BF94")
		.withDescription("TI-99/4 Console GROM")
		.create("CPU GROM");
	
    public TI994StandardConsoleMemoryModel(IMachine machine) {
    	super(machine);
    }
