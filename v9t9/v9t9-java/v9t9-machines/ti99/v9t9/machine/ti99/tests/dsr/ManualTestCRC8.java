 ...
 *
 */
public class ManualTestCRC8 {

	private Map<Integer, Integer> crcMatches = new HashMap<Integer, Integer>();
	
	public static void main(String[] args) {
		ManualTestCRC8 crc = new ManualTestCRC8();
		for (int i = 1; i < 0xffff; i+=2) {
			crc.run(new CRC16(i), new byte[] { 0, 0, 0, 1 }, 0xfa00);
			crc.run(new CRC16(i), new byte[] { 0, 0, 0xb, 1 }, 0x5800);
			crc.run(new CRC16(i), new byte[] { 0, 0, 4, 1 }, 0x4800);
			crc.run(new CRC16(i), new byte[] { 0, 0, 0xf, 1 }, 0x9400);
		}
