 ...
 *
 */
public class HighLevelCodeInfo9900 implements IDecompileInfo {
	//Cpu cpu;
	...
	private TopDownPhase9900 phase;
	private boolean scanned;
	private ICpuState state;
	private final IInstructionFactory instructionFactory;

	public HighLevelCodeInfo9900(ICpuState state, IInstructionFactory instructionFactory) {
		this.state = state;
...
/*	
	...
	public void analyze() {
		if (!scanned) {
			...
			phase = new TopDownPhase9900(state, this);
			phase.run();
		}
	}
