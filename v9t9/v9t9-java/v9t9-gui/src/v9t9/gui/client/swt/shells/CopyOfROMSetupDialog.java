 ...
 *
 */
public class CopyOfROMSetupDialog extends Dialog {
	...
	*/
	public static CopyOfROMSetupDialog createDialog(Shell shell, final IMachine machine,
			final SwtWindow window) {
		 return new CopyOfROMSetupDialog(shell, machine, window, 
						machine.getMemoryModel().getRequiredRomMemoryEntries(),
						machine.getMemoryModel().getOptionalRomMemoryEntries()
						);
	}
	...
	public CopyOfROMSetupDialog(Shell shell, IMachine machine_, SwtWindow window,
