...
import v9t9.tools.asm.SymbolTable;
import v9t9.tools.asm.directive.LabelDirective;
import v9t9.tools.asm.transform.JumpFixer9900;
import v9t9.tools.asm.transform.Simplifier9900;
...
public class Assembler9900 extends Assembler implements IAssembler {
	...
	/* (non-Javadoc)
	 * @see v9t9.tools.asm.inst9900.Assembler#injectInstruction(v9t9.tools.asm.LLInstruction)
	 */
	@Override
