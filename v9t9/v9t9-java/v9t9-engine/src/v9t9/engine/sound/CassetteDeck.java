...
public class CassetteDeck extends BaseRegisterBank implements ICassetteDeck {
	...
	public CassetteDeck(String id, String name,
		...
		dumpCassetteAccess = machine.getSettings().get(ICassetteChip.settingDumpCassetteAccess);
		
		cassetteDebug = machine.getSettings().get(ICassetteChip.settingCassetteDebug);
//
//		cassetteInput.addListener(new IPropertyListener() {
//			
//			@Override
//			public void propertyChanged(IProperty property) {
//				if (new File(property.getString()).isFile())
//					stopCassette();
//			}
//		});
//		
	...
	public void recordCassette() {
		...
		synchronized (this) {
			...
			soundListener.started(generator.getAudioFormat());
			soundListener.setIncludeSilence(motor != 0);
	...
	public void setMotor(boolean motor) {
		...
		if (cpu != null) {
			...
			synchronized (this) {
				if (soundListener != null)
					soundListener.setIncludeSilence(motor);
			}
		}
	}
