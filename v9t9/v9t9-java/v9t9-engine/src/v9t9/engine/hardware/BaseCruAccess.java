 ...
 * @author ejs
 */
public class BaseCruAccess implements ICruAccess {
    IMachine machine;
	...
	protected final KeyboardState keyboardState;
	protected long clockTargetCycleCount;
	protected boolean intreq;

	private final int intCount;
	
    public BaseCruAccess(IMachine machine, KeyboardState keyboardState, int intCount) {
