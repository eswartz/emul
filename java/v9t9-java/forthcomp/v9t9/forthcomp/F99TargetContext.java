...
public class F99TargetContext extends TargetContext {
	...
	/* (non-Javadoc)
	 * @see v9t9.forthcomp.TargetContext#compile(v9t9.forthcomp.ITargetWord)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see v9t9.forthcomp.words.TargetContext#compilePostpone(v9t9.forthcomp.ITargetWord)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see v9t9.forthcomp.words.TargetContext#compileDoes(v9t9.forthcomp.HostContext, v9t9.forthcomp.DictEntry, int)
	 */
	@Override
