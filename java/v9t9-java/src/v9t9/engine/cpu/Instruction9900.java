...
public class Instruction9900 extends RawInstruction implements IInstruction {
    ...
    public void completeInstruction(int Pc) {        
	    this.info.stsetBefore = Instruction9900.st_NONE;
	    this.info.stsetAfter = Instruction9900.st_NONE;
	    this.info.stReads = 0;
	    this.info.jump = Instruction9900.INST_JUMP_FALSE;
	    this.info.reads = 0;
	    this.info.writes = 0;
	    ...
	    if (inst == InstTableCommon.Idata) {
	        ...
	        case Inst9900.Ili:
	            ...
	            break;
	        case Inst9900.Iai:
	            this.info.stsetBefore = Instruction9900.st_ADD_LAECO_REV;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Iandi:
	            this.info.stsetAfter = Instruction9900.st_LAE_1;
	        ...
	        Check.checkArg((mop2.type == MachineOperand.OP_NONE));
	        mop1.dest = Operand.OP_DEST_KILLED;
	        this.info.reads |= INST_RSRC_WP;
	        this.info.cycles += 8;
	    } else if (inst == Inst9900.Istst) {
	        Check.checkArg((mop1.type == InstTable9900.OP_REG));
	        this.info.reads |= INST_RSRC_ST;
	        ...
	        case Inst9900.Irset:
	            ...
	            break;
	        case Inst9900.Irtwp:
	            this.info.stsetAfter = Instruction9900.st_ALL;
	            this.info.writes |= INST_RSRC_WP + INST_RSRC_ST + INST_RSRC_PC;
	            mop1.type = InstTable9900.OP_STATUS;
	            //mop1.dest = Operand.OP_DEST_KILLED;	// compiler doesn't seem to depend on this
	            this.info.jump = Instruction9900.INST_JUMP_TRUE;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Ickon:
	            this.info.writes |= INST_RSRC_IO;
	        ...
	        case Inst9900.Iblwp:
	            ...
	            this.info.stReads = 0xffff;
	            this.info.reads |= INST_RSRC_ST;
	            this.info.writes |= INST_RSRC_WP + INST_RSRC_PC + INST_RSRC_CTX;
	            mop1.dest = Operand.OP_DEST_FALSE;
	        ...
	        case Inst9900.Iclr:
	            ...
	            break;
	        case Inst9900.Ineg:
	            this.info.stsetAfter = Instruction9900.st_LAEO;
	            this.info.cycles += 12;
	            break;
	        case Inst9900.Iinv:
	            this.info.stsetAfter = Instruction9900.st_LAE_1;
	            ...
	            break;
	        case Inst9900.Iinc:
	            this.info.stsetBefore = Instruction9900.st_ADD_LAECO_REV_1;
	            this.info.cycles += 10;
	            break;
	        case Inst9900.Iinct:
	            this.info.stsetBefore = Instruction9900.st_ADD_LAECO_REV_2;
	            this.info.cycles += 10;
	            break;
	        case Inst9900.Idec:
	            this.info.stsetBefore = Instruction9900.st_ADD_LAECO_REV_N1;
	            this.info.cycles += 10;
	            break;
	        case Inst9900.Idect:
	            this.info.stsetBefore = Instruction9900.st_ADD_LAECO_REV_N2;
	            this.info.cycles += 10;
	            break;
	        case Inst9900.Ibl:
	            mop1.dest = Operand.OP_DEST_FALSE;
	        ...
	        case Inst9900.Iseto:
	            ...
	            break;
	        case Inst9900.Iabs:
	            this.info.stsetBefore = Instruction9900.st_LAEO;
	            this.info.cycles += 12;
	            break;
	        default:
	            mop1.dest = Operand.OP_DEST_FALSE;
	        ...
	        if (mop2.val == 0) {
	            mop2.type = InstTable9900.OP_REG0_SHIFT_COUNT;
	            this.info.cycles += 20;
	        } else {
	            this.info.cycles += 12;
	        }
	        ...
	        case Inst9900.Isrl:
	            ...
	            break;
	        case Inst9900.Isla:
	            this.info.stsetBefore = Instruction9900.st_SHIFT_LEFT_CO;
	            this.info.stsetAfter = Instruction9900.st_LAE_1;
	            break;
	        case Inst9900.Isrc:
	            this.info.stsetBefore = Instruction9900.st_SHIFT_RIGHT_C;
	        ...
	        if (inst < Inst9900.Isbo) {
	        	...
	        	} else if (mop1.type != InstTable9900.OP_JUMP){
	            ...
	            this.info.jump = inst == Inst9900.Ijmp ? Instruction9900.INST_JUMP_TRUE
	                    : Instruction9900.INST_JUMP_COND;
	            this.info.cycles += 8;
	        } else {
	        ...
	        case Inst9900.Ijmp:
	            ...
	            break;
	        case Inst9900.Ijlt:
	            this.info.stReads = Status9900.ST_A + Status9900.ST_E;
	            break;
	        case Inst9900.Ijle:
	            this.info.stReads = Status9900.ST_A + Status9900.ST_E;
	            break;
	        case Inst9900.Ijeq:
	            this.info.stReads = Status9900.ST_E;
	            break;
	        case Inst9900.Ijhe:
	        ...
	        case Inst9900.Ijne:
	            ...
	            break;
	        case Inst9900.Ijnc:
	            this.info.stReads = Status9900.ST_C;
	            break;
	        case Inst9900.Ijoc:
	            this.info.stReads = Status9900.ST_C;
	            break;
	        case Inst9900.Ijno:
	            this.info.stReads = Status9900.ST_O;
	            break;
	        case Inst9900.Ijl:
	            this.info.stReads = Status9900.ST_L + Status9900.ST_E;
	            break;
	        ...
	        case Inst9900.Ixop:
	            ...
	            mop2.type = InstTable9900.OP_CNT;
	            mop2.dest = Operand.OP_DEST_FALSE;
	            this.info.stsetAfter = Instruction9900.st_XOP;
	            this.info.jump = Instruction9900.INST_JUMP_TRUE;
	            this.info.cycles += 36;
	            break;
	        case Inst9900.Impy:
	            ...
	            break;
	        case Inst9900.Idiv:
	            this.info.stsetBefore = Instruction9900.st_DIV_O;
	            //              ((MachineOperand) this.op2).type = MachineOperand.OP_DIV;
	            this.info.cycles += 124;
	            break;
	        }
	        ...
	        if (inst == Inst9900.Ildcr) {
	            ...
	            mop1.dest = Operand.OP_DEST_FALSE;
	            this.info.cycles += (20 + 2 * mop1.val);
	            this.info.writes |= INST_RSRC_IO;
	        } else {
	            this.info.stsetAfter = mop1.byteop ? Instruction9900.st_BYTE_LAEP_1
	                    : Instruction9900.st_LAE_1;
	            mop1.dest = Operand.OP_DEST_TRUE;
	            this.info.cycles += (mop1.val < 8 ? 42
				: mop1.val == 8 ? 44 : 58);
	            this.info.reads |= INST_RSRC_IO;
	        }
	        ...
	        case Inst9900.Iszc:
	            ...
	            break;
	        case Inst9900.Iszcb:
	            this.info.stsetAfter = Instruction9900.st_BYTE_LAEP;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Is:
	            this.info.stsetBefore = Instruction9900.st_SUB_LAECO;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Isb:
	            this.info.stsetBefore = Instruction9900.st_SUB_BYTE_LAECOP;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Ic:
	            this.info.stsetAfter = Instruction9900.st_CMP;
	            ...
	            break;
	        case Inst9900.Icb:
	            this.info.stsetAfter = Instruction9900.st_BYTE_CMP;
	            mop2.dest = Operand.OP_DEST_FALSE;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Ia:
	            this.info.stsetBefore = Instruction9900.st_ADD_LAECO;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Iab:
	            this.info.stsetBefore = Instruction9900.st_ADD_BYTE_LAECOP;
	            this.info.cycles += 14;
	            break;
	        case Inst9900.Imov:
	            this.info.stsetAfter = Instruction9900.st_LAE;
	    ...
	    if (this.info.jump != INST_JUMP_FALSE) {
	        this.info.writes |= INST_RSRC_PC;
	        this.info.reads |= INST_RSRC_PC;
	    }
	    if (info.stsetBefore != st_NONE || info.stsetAfter != st_NONE) {
	        this.info.writes |= INST_RSRC_ST;
	    }
    ...
    public static Effects getInstructionEffects(int inst) {
	    ...
	    fx.stReads = 0;
	    fx.jump = Instruction9900.INST_JUMP_FALSE;
	    fx.reads = 0;
	    fx.writes = 0;
	    fx.byteop = false;
	    ...
	    if (inst == InstTableCommon.Idata) {
	        ...
	        case Inst9900.Irtwp:
	            ...
	            fx.jump = Instruction9900.INST_JUMP_TRUE;
	            break;
	        case Inst9900.Ickon:
	            fx.writes |= INST_RSRC_IO;
	            break;
	        ...
	        if (inst < Inst9900.Isbo) {
	            fx.reads |= INST_RSRC_ST;
	            fx.jump = inst == Inst9900.Ijmp ? Instruction9900.INST_JUMP_TRUE
	                    : Instruction9900.INST_JUMP_COND;
	        }
