...
public class InstructionTest extends TestCase {
    ...
    public void testToString() {
        ...
        assertEquals("CLR", InstructionTable.getInstName(inst.inst));
        ...
        assertEquals("JMP", InstructionTable.getInstName(inst.inst));
        assertEquals(false, mop1.byteop);
        ...
        assertEquals("JNC", InstructionTable.getInstName(inst.inst));
        assertEquals(false, mop1.byteop);
        assertEquals(MachineOperand.OP_JUMP, mop1.type);
        ...
        assertEquals("MOV", InstructionTable.getInstName(inst.inst));
        assertEquals(false, mop1.byteop);
        ...
        assertEquals("CB", InstructionTable.getInstName(inst.inst));
