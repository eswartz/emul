 ...
 *
 */
public class AstBreakStmt extends AstTypedExpr implements IAstBreakStmt  {
	 ...
	 * @param expr
	 */
	public AstBreakStmt(IAstTypedExpr expr) {
		setExpr(expr);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AstBreakStmt other = (AstBreakStmt) obj;
		if (expr == null) {
			if (other.expr != null)
				return false;
